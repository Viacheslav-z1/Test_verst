...
jQuery(document).ready(function () {
    ...
    $(".bq1").click(function (e) {
      $("#q1").fadeOut("slow", function () {
        $("#q2").fadeIn("slow");
        answ1 = e.target.querySelector(".answ-bq1").textContent;
      ...
      $(".bq2").click(function (e) {
        $("#q2").fadeOut("slow", function () {
          $("#q3").fadeIn("slow");
           answ2 = e.target.querySelector(".answ-bq2").textContent;
      ...
      $(".bq3").click(function (e) {
        $("#q3").fadeOut("slow", function () {
          $("#q4").fadeIn("slow");
           answ3 = e.target.querySelector(".answ-bq3").textContent;
      ...
      $(".bq4").click(function (e) {
         ...
         if (e.target.classList.contains("survey_button")) {
           answ4 = e.target.querySelector(".answ-bq4").textContent;
         } else {
